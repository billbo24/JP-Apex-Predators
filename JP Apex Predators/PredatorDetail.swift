...
//  JP Apex Predators
//
//  Created by William Floyd on 2/19/23.
//
        ...
        ScrollView{
            VStack(alignment: .trailing){
                ...
                Image(predator.name.lowercased().filter {$0 != " "})
                    .resizable()
                    .scaledToFit()
                    .frame(width: UIScreen.main.bounds.width / 1.5,height: UIScreen.main.bounds.height / 4) //This allows for the size to be dynamic.  It takes the width and height of the phone and works from there
                    .shadow(color: .cyan, radius: 6,x:0,y:0)
                    .offset(y:-210) //Don't love this being hard coded
                ...
                VStack(alignment: .leading) {
                    ...
                    //This says use the string itself as an id
                    ...
                    //Exclamation point overrides the  "wait is this real" check by swift
                    Link(predator.link,destination: URL(string: predator.link)!)
                        .font(.caption)
                        .foregroundColor(.blue)
                }
                .padding(.top,-220) //this is dumb but w/e
            }
        }
